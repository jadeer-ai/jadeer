        ...
        <div className="lg:col-span-4 space-y-7">
          ...
          <div className="bg-white rounded-3xl p-6 border border-slate-200/80 shadow-[0_4px_20px_rgba(15,23,42,0.03)] space-y-4">
            <div className="flex items-center justify-between border-b border-slate-100 pb-3">
              ...
              <span className="text-[10px] font-medium text-slate-500 bg-[#F8F9FA] px-2.5 py-0.5 rounded-full border border-slate-200">
                PDF Document
              </span>
            </div>
            ...
            <div className="p-3.5 rounded-2xl bg-[#F8F9FA] border border-slate-200/60 space-y-3">
              ...
              <div className="flex items-center gap-2 pt-2 border-t border-slate-200/60">
                ...
                <button
                  ...
                  className="flex-1 inline-flex items-center justify-center gap-1.5 py-2 px-3 rounded-xl bg-[#5E8174] text-white text-xs font-bold hover:bg-[#4d6d62] transition-all cursor-pointer active:scale-95 shadow-2xs"
                >

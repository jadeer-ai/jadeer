...
/* ═══════════════════════════════════════════════════════════════════════════
   JADEER — MODULAR LOGIN COMPONENT (Login.tsx)
   ─────────────────────────────────────────────────────────────────────────
   Premium, accessible, and responsive authentication component matching the
   registration system and dashboard visual language.
   ═══════════════════════════════════════════════════════════════════════════ */
...
export function Login({ onSuccess, defaultEmail = '', className = '' }: LoginProps) {
      ...
      <div className="bg-white rounded-3xl p-8 sm:p-10 border border-[#0B0F19]/[0.05] shadow-[0_20px_60px_-15px_rgba(0,0,0,0.03)] space-y-7 animate-[fade-in_0.4s_ease]">
        ...
        {isSuccess && (
          <div className="flex items-center gap-2.5 p-3.5 rounded-2xl bg-emerald-50 border border-emerald-200 text-emerald-700 text-xs animate-[fade-in_0.2s_ease]">
            ...
            <p className="font-semibold">Authentication verified. Loading workspace...</p>
          </div>
        )}
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-1.5">
            <label htmlFor="login-component-email-input" className="text-xs font-bold uppercase tracking-wider text-[#0B0F19]/60">
              Registered Email
            </label>
            <div className="relative">
              <input
                id="login-component-email-input"
                type="email"
                value={email}
                onChange={(e) => {
          ...
          <div className="space-y-1.5">
            <div className="flex items-center justify-between">
              <label htmlFor="login-component-password-input" className="text-xs font-bold uppercase tracking-wider text-[#0B0F19]/60">
                Password
              </label>
              <button
                type="button"
          ...
          <div className="flex items-center justify-between pt-1">
            <label htmlFor="login-component-remember-me" className="flex items-center gap-2 text-xs text-[#0B0F19]/65 cursor-pointer select-none">
              <input
                id="login-component-remember-me"
                type="checkbox"
                checked={rememberMe}
        ...
        <div className="grid grid-cols-4 gap-2.5">
          <button
            type="button"
            id="login-component-google-btn"
            disabled={socialLoading !== null || isLoading || isSuccess}
          ...
          <button
            type="button"
            id="login-component-linkedin-btn"
            disabled={socialLoading !== null || isLoading || isSuccess}
